...
\]
\par
This stratified test is useful when the distributions of the stratum variable in the treatment-control groups are different, but the distribution of these relavent covariates within each stratum is the same between the treatment-control groups.
