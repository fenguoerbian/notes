...
\par
For a simple and special case, assume $G_0\left(\cdot\right) = G_1\left(\cdot\right)$ (i.e., same censoring distribution in each group); $w\left(t\right) = 1$ (i.e., ordinary logrank test); $\lambda_1\left(t\right) / \lambda_0\left(t\right) = \rho$ (i.e., constant hazard ratio);
