  ...
  \prod\limits_{j = 1}^K\left\{
    \prod\limits_{i = 1}^{d_j}\left\{
      \frac{\mathrm{exp}\left(\beta z_{\left(j\right)}^{\left(i\right)}\right)}{
        \sum\limits_{l\in R_j}\mathrm{exp}\left(\beta z_{\left(l\right)}\right)
      }
    \right\}
  \right\}
  .
...
\[
  \begin{aligned}
    & \frac{
      \mathrm{exp}\left(\beta z_1\right)
    }{
      \mathrm{exp}\left(\beta z_1\right)
      + \mathrm{exp}\left(\beta z_2\right)
      + \mathrm{exp}\left(\beta z_3\right)
    }
    \times \frac{
      \mathrm{exp}\left(\beta z_2\right)
    }{
    ...
    =& \frac{
      \mathrm{exp}\left(\beta \left(z_1 + z_2\right)\right)
    }{
       \mathrm{exp}\left(\beta z_1\right)
      + \mathrm{exp}\left(\beta z_2\right)
      + \mathrm{exp}\left(\beta z_3\right)
    ...
    \times \left(
      \frac{1}{\mathrm{exp}\left(\beta z_2\right) + \mathrm{exp}\left(\beta z_3\right)}
      + \frac{1}{\mathrm{exp}\left(\beta z_1\right) + \mathrm{exp}\left(\beta z_3\right)}
    \right)
  \end{aligned}
\]
  ...
  \[
    \frac{
      ...
      \frac{1}{
        ...
        + \mathrm{exp}\left(\beta z_3\right)
        - \frac{1}{2}\left(
          \mathrm{exp}\left(\beta z_1\right) + \mathrm{exp}\left(\beta z_2\right)
        \right)
      }
  \]
\end{enumerate}
