...
\]
is the number of subjects that are ``at risk'' at time $v_k$. \textbf{Note: }by the word ``at risk'', we also count the subjects that died just at $v_k$, which means $Y\left(v_j\right) \geq d_j$.
\par
