...
There are mainly two types of situations that's suitable for a Pearson's Chi-square test. The first is to test one sample against a given vector, the so-called contigency test. And the second is to test the existence of correlation between two samples.
